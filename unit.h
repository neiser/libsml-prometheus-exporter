...
std::map<uint8_t, std::string> unit_table{
    ...
    {31,
     "VAh"},      // apparent energy		volt-ampere-hour	VA*(60*60s)
    ...
    {60, "Wh/m³"},       // energy per volume					3,6*103
                         // J/m³
    {61, "J/m³"},        // calorific value, wobbe
    {62, "Mol %"},       // molar fraction of		mole percent		(Basic
                         // gas composition unit) gas composition
    {63, "g/m³"},        // mass density, quantity of material			(Gas
                         // analysis, accompanying elements)
    {64, "Pa s"},        // dynamic viscosity pascal second
                         // (Characteristic of gas stream)
